 ...
 */
const getExecuteParams = (params) => JSON.stringify(params, (_key, value) => typeof value === 'object' && value !== params ? String(value) : value);
/**
...
class SequentialWorker extends APIWorker {
    ...
    async handleError(request, error) {
        ...
        (_a = request.captchaValidate) === null || _a === void 0 ? void 0 : _a.reject(error);
        if (code !== exports.APIErrorCode.CAPTCHA || !((_b = this.api.options.callbackService) === null || _b === void 0 ? void 0 : _b.hasCaptchaHandler)) {
            request.reject(error);
            return;
        }
        try {
...
class ParallelSelectedWorker extends ParallelWorker {
    skipMethod(method) {
        return super.skipMethod(method) || !this.api.options.apiExecuteMethods.includes(method);
    }
}
    ...
    constructor(options) {
        ...
        for (const group of groupMethods) {
            ...
            this[group] = new Proxy(Object.create(null), {
                get: (_obj, prop) => (params) => this.callWithRequest(new APIRequest({
                    api: this,
                    method: `${group}.${prop}`,
                    params,
                })),
...
async function* createCollectIterator({ api, method, params: rawParams = {}, countPerRequest, maxCount = Number.POSITIVE_INFINITY, retryLimit = 3, parallelRequests = 25, }) {
    var _a, _b;
...
class WallAttachment extends Attachment {
    ...
    get hasUserReposted() {
        ...
        return Boolean((_a = this.payload.reposts) === null || _a === void 0 ? void 0 : _a.user_reposted);
    }
    /**
    ...
    get hasUserLike() {
        ...
        return Boolean((_a = this.payload.likes) === null || _a === void 0 ? void 0 : _a.user_likes);
    }
    /**
    ...
    get isCanUserCommented() {
        ...
        return Boolean((_a = this.payload.comments) === null || _a === void 0 ? void 0 : _a.can_post);
    }
    /**
    ...
    get isCanGroupsCommented() {
        ...
        return Boolean((_a = this.payload.comments) === null || _a === void 0 ? void 0 : _a.groups_can_post);
    }
    /**
    ...
    get isCanCloseComments() {
        ...
        return Boolean((_a = this.payload.comments) === null || _a === void 0 ? void 0 : _a.can_close);
    }
    /**
    ...
    get isCanOpenComments() {
        ...
        return Boolean((_a = this.payload.comments) === null || _a === void 0 ? void 0 : _a.can_open);
    }
    /**
    ...
    get isCanLike() {
        ...
        return Boolean((_a = this.payload.likes) === null || _a === void 0 ? void 0 : _a.can_like);
    }
    /**
    ...
    get isCanReposted() {
        ...
        return Boolean((_a = this.payload.likes) === null || _a === void 0 ? void 0 : _a.can_publish);
    }
    /**
 ...
 */
const transformAttachments = (rawAttachments, api) => {
    const attachments = [];
...
class CommentContext extends Context {
    constructor(options) {
        ...
        super({
            ...options,
            type: 'comment',
            subTypes: [initiator, options.updateType],
        });
...
const DocumentKind = {
    ...
    graffiti: exports.AttachmentType.GRAFFITI, // I know this is stupid
};
...
class MessageContext extends Context {
    constructor(options) {
        ...
        this.subTypes = [
            this.eventType || subTypesEnum[options.updateType] || options.updateType,
        ];
    }
    /**
     ...
     */
    editMessage(params) {
        const target = this.id !== 0 ? { message_id: this.id } : { conversation_message_id: this.conversationMessageId };
    ...
    applyPayload(payload) {
        ...
        if (message.reply_message) {
            ...
            this[kReplyMessage] = new MessageContext({
                api: this.api,
                upload: this.upload,
                source: this.$filled ? exports.UpdateSource.WEBHOOK : exports.UpdateSource.POLLING,
                groupId: this.$groupId,
                updateType: 'message_new',
                state: this.state,
                payload: {
...
const transformPolling = ({ 1: toId, 2: fromIds }, updateType) => ({
    from_id: fromIds[0],
    to_id: toId,
    state: typeof updateType === 'string' ? updateType : stateTypesEnum[updateType],
});
...
const defaultNextHandler = (_req, res) => {
    res.writeHead(403);
    res.end();
};
class WebhookTransport {
    ...
    async start({ path = '/', tls, host, port: customPort, next = defaultNextHandler, } = {}) {
        ...
        try {
            ...
            this.webhookServer = tls ? https.createServer(tls, callback) : http.createServer(callback);
...
class Updates {
    ...
    constructor({ api, upload, ...options }) {
        this.composer = middlewareIo.Composer.builder().caught((_context, error) => {
            console.error(error);
        });
        this.api = api;
        this.upload = upload;
    ...
    on(rawEvents, rawHandlers) {
        ...
        const handler = Array.isArray(rawHandlers) ? middlewareIo.compose(rawHandlers) : rawHandlers;
    ...
    async buildPayload({ field, values, maxFiles, attachmentType, }) {
        ...
        const tasks = values.map(async (media, i) => {
            ...
            if (isStream(value) || isBuffer) {
                ...
                const fileContentType = contentType || DefaultContentType[attachmentType];
                const file = isBuffer
...
const transformNumberResourceToTarget = (resource) => resource < 0 ? `club${-resource}` : `id${resource}`;
