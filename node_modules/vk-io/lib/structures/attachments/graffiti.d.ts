...
export declare class GraffitiAttachment extends Attachment<IGraffitiAttachmentPayload, AttachmentType.GRAFFITI | 'graffiti'> {
    /**
     * Constructor
     */
    constructor(options: GraffitiAttachmentOptions);
    /**
