...
export declare class AudioAttachment extends Attachment<IAudioAttachmentPayload, AttachmentType.AUDIO | 'audio'> {
    /**
     * Constructor
     */
    constructor(options: AudioAttachmentOptions);
    /**
     ...
     */
    get isHq(): boolean | undefined;
    /**
     * Returns the ID of the lyric
     */
    get lyricsId(): number | undefined;
    /**
