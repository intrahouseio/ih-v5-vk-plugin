...
class SequentialWorker extends APIWorker {
    ...
    async handleError(request, error) {
        ...
        (_a = request.captchaValidate) === null || _a === void 0 ? void 0 : _a.reject(error);
        if (code !== APIErrorCode.CAPTCHA || !((_b = this.api.options.callbackService) === null || _b === void 0 ? void 0 : _b.hasCaptchaHandler)) {
            request.reject(error);
            return;
        }
        try {
...
class Updates {
    ...
    constructor({ api, upload, ...options }) {
        this.composer = Composer.builder().caught((_context, error) => {
            console.error(error);
        });
        this.api = api;
        this.upload = upload;
