...
import { CommentContext, type CommentContextSubType, type CommentContextType, type Context, type ContextDefaultState, DialogFlagsContext, type DialogFlagsContextSubType, type DialogFlagsContextType, DialogMessagesContext, type DialogMessagesContextSubType, type DialogMessagesContextType, DialogNotificationSettingsContext, type DialogNotificationSettingsContextSubType, type DialogNotificationSettingsContextType, DonutSubscriptionContext, type DonutSubscriptionContextSubType, type DonutSubscriptionContextType, DonutSubscriptionPriceContext, type DonutSubscriptionPriceContextSubType, type DonutSubscriptionPriceContextType, DonutWithdrawContext, type DonutWithdrawContextSubType, type DonutWithdrawContextType, FriendActivityContext, type FriendActivityContextSubType, type FriendActivityContextType, GroupMemberContext, type GroupMemberContextSubType, type GroupMemberContextType, GroupUpdateContext, type GroupUpdateContextSubType, type GroupUpdateContextType, GroupUserContext, type GroupUserContextSubType, type GroupUserContextType, LikeContext, type LikeContextSubType, type LikeContextType, MarketOrderContext, type MarketOrderContextSubType, type MarketOrderContextType, MessageContext, type MessageContextSubType, type MessageContextType, MessageEventContext, type MessageEventContextSubType, type MessageEventContextType, MessageFlagsContext, type MessageFlagsContextSubType, type MessageFlagsContextType, MessageSubscriptionContext, type MessageSubscriptionContextSubType, type MessageSubscriptionContextType, MessagesReadContext, type MessagesReadContextSubType, type MessagesReadContextType, NewAttachmentsContext, type NewAttachmentsContextSubType, type NewAttachmentsContextType, TypingContext, type TypingContextSubType, type TypingContextType, UnsupportedEventContext, type UnsupportedEventContextType, VKAppPayloadContext, type VKAppPayloadContextSubType, type VKAppPayloadContextType, VKPayTransactionContext, type VKPayTransactionContextSubType, type VKPayTransactionContextType, VoteContext, type VoteContextSubType, type VoteContextType, WallPostContext, type WallPostContextSubType, type WallPostContextType } from '../structures';
import type { Upload } from '../upload';
import { type IWebhookTransportStartOptions, type WebhookTransportCallback, type WebhookTransportKoaCallback } from './transports';
